...
<svelte:head>
  <title>{data.category.name} - Blog</title>
...
<main class="container mx-auto px-6 py-8 space-y-8">
  <header class="space-y-2">
    ...
    <h1 class="text-3xl font-bold tracking-tight">{data.category.name}</h1>
    {#if data.category.description}
      <p class="text-muted-foreground text-sm">{data.category.description}</p>
    {/if}
  </header>
