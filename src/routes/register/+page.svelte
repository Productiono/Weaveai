  ...
  >
    <div class="relative hidden h-full flex-col bg-muted p-10 lg:flex">
      ...
      <div class="relative z-20 mt-auto space-y-3">
        <p class="text-3xl font-bold tracking-tight">Create your account</p>
        <p class="text-sm text-muted-foreground">
          Join {data.settings.siteName} to start building your personalized AI
          workspace.
        </p>
      </div>
    </div>
        ...
        <Card.Root>
          <Card.Header class="space-y-2 text-center">
            ...
            <Card.Description class="text-sm text-muted-foreground">
              Sign up with an email address or continue with a provider.
            </Card.Description>
          </Card.Header>
